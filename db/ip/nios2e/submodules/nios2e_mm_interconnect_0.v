...
module nios2e_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                  // nios2_qsys_0_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire  [95:0] period0_s1_agent_rf_source_data;                                                    // PERIOD0_s1_agent:rf_source_data -> PERIOD0_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] period0_s1_agent_rsp_fifo_out_data;                                                 // PERIOD0_s1_agent_rsp_fifo:out_data -> PERIOD0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> PERIOD0_s1_agent:cp_valid
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> PERIOD0_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // PERIOD0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> PERIOD0_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> PERIOD0_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> PERIOD0_s1_agent:cp_endofpacket
	...
	wire  [95:0] decode0_s1_agent_rf_source_data;                                                    // DECODE0_s1_agent:rf_source_data -> DECODE0_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] decode0_s1_agent_rsp_fifo_out_data;                                                 // DECODE0_s1_agent_rsp_fifo:out_data -> DECODE0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> DECODE0_s1_agent:cp_valid
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> DECODE0_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // DECODE0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> DECODE0_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> DECODE0_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> DECODE0_s1_agent:cp_endofpacket
	...
	wire  [94:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire         period0_s1_agent_rp_valid;                                                          // PERIOD0_s1_agent:rp_valid -> router_003:sink_valid
	wire  [94:0] period0_s1_agent_rp_data;                                                           // PERIOD0_s1_agent:rp_data -> router_003:sink_data
	wire         period0_s1_agent_rp_ready;                                                          // router_003:sink_ready -> PERIOD0_s1_agent:rp_ready
	wire         period0_s1_agent_rp_startofpacket;                                                  // PERIOD0_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         period0_s1_agent_rp_endofpacket;                                                    // PERIOD0_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         decode0_s1_agent_rp_valid;                                                          // DECODE0_s1_agent:rp_valid -> router_004:sink_valid
	wire  [94:0] decode0_s1_agent_rp_data;                                                           // DECODE0_s1_agent:rp_data -> router_004:sink_data
	wire         decode0_s1_agent_rp_ready;                                                          // router_004:sink_ready -> DECODE0_s1_agent:rp_ready
	wire         decode0_s1_agent_rp_startofpacket;                                                  // DECODE0_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         decode0_s1_agent_rp_endofpacket;                                                    // DECODE0_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         period0_s1_agent_rdata_fifo_src_valid;                                              // PERIOD0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] period0_s1_agent_rdata_fifo_src_data;                                               // PERIOD0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         period0_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_001:in_0_ready -> PERIOD0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> PERIOD0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> PERIOD0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // PERIOD0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> PERIOD0_s1_agent:rdata_fifo_sink_error
	wire         decode0_s1_agent_rdata_fifo_src_valid;                                              // DECODE0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] decode0_s1_agent_rdata_fifo_src_data;                                               // DECODE0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         decode0_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_002:in_0_ready -> DECODE0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> DECODE0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> DECODE0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // DECODE0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> DECODE0_s1_agent:rdata_fifo_sink_error
	...
	nios2e_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
